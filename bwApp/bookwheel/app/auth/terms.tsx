    ...
    <>
      ...
      >
        ...
        <Section title="제1조 (목적)">
          이 약관은 Bookwheel(이하 "서비스")이 제공하는 교환독서 기반 독서 관리
          및 커뮤니티 서비스의 이용과 관련하여 서비스와 회원 간의 권리, 의무 및
          책임사항을 규정하는 것을 목적으로 합니다.
        </Section>

        <Section title="제2조 (용어의 정의)">
          1. "서비스"란 Bookwheel이 제공하는 교환독서, 그룹 독서, 도서 기록 및
          관련 커뮤니티 기능을 의미합니다.{"\n\n"}
          2. "회원"이란 본 약관에 동의하고 회원가입을 완료하여 서비스를 이용하는
          사람을 의미합니다.{"\n\n"}
          3. "그룹"이란 회원들이 함께 독서 활동을 진행하기 위해 서비스를 통해
          생성하거나 참여하는 독서 모임을 의미합니다.{"\n\n"}
        ...
        <Section title="제4조 (회원가입)">
          1. 회원가입은 회원이 서비스에서 정한 가입 절차에 따라 필요한 정보를
          입력하고 본 약관 및 개인정보 처리방침에 동의함으로써 완료됩니다.
          {"\n\n"}
          2. 회원은 정확하고 최신의 정보를 제공해야 합니다.{"\n\n"}
          3. 회원이 허위 정보를 제공하여 발생하는 문제에 대해서는 해당 회원이
          책임을 부담합니다.
        </Section>
        ...
        <Section title="제6조 (회원의 의무)">
          ...
          4. 욕설, 비방, 혐오 또는 타인에게 불쾌감을 주는 콘텐츠를 게시하는 행위
          {"\n\n"}
        ...
        <Section title="제7조 (회원의 콘텐츠)">
          ...
          {"\n\n"}
          2. 회원은 자신이 게시하는 콘텐츠에 대해 필요한 권리를 보유하고 있어야
          합니다.{"\n\n"}
          3. 서비스는 법령 또는 본 약관에 위반되는 콘텐츠에 대해 관련 법령 및
          내부 기준에 따라 삭제 또는 이용 제한 등의 조치를 취할 수 있습니다.
        </Section>

        <Section title="제8조 (서비스 이용 제한)">
          회원이 관련 법령 또는 본 약관을 위반하거나 서비스의 정상적인 운영을
          방해하는 경우 서비스는 해당 회원의 서비스 이용을 제한하거나 회원자격을
          정지 또는 해지할 수 있습니다.
        </Section>

        <Section title="제9조 (회원 탈퇴)">
          회원은 서비스에서 제공하는 절차를 통해 언제든지 회원 탈퇴를 요청할 수
          있습니다. 탈퇴 이후에도 관련 법령 또는 개인정보 처리방침에 따라 일정
          기간 보관이 필요한 정보는 해당 기간 동안 보관될 수 있습니다.
        </Section>

        <Section title="제10조 (서비스의 변경 및 중단)">
          서비스는 운영상, 기술상 또는 기타 필요한 사유가 있는 경우 서비스의
          일부 또는 전부를 변경하거나 일시적으로 중단할 수 있습니다. 중요한 변경
          또는 중단이 있는 경우 가능한 범위에서 회원에게 사전에 안내합니다.
        </Section>
        ...
        <Section title="제12조 (준거법 및 관할)">
          서비스와 회원 간의 분쟁에 대해서는 대한민국 법령을 준거법으로 합니다.
          서비스 이용과 관련하여 분쟁이 발생하는 경우 관련 법령에서 정한 절차에
          따라 해결합니다.
        </Section>
